...
export declare type player_summary<id extends steam_id = steam_id, byte extends avatar_hex_byte = avatar_hex_byte, hash extends avatar_hash = avatar_hash, vanity extends string = string> = {
    steamid: id;
