...
// const to_app_image_url = <T extends app_image_url> (domain: string) =>
//    (game: app_id, image_id: image_id) =>
//       `https://${domain}/${images_dir}/${game}/${image_id}.jpg` as T;

// export const to_steam_cdn_url = to_app_image_url<steam_app_image_url>("media.steampowered.com");
// export const to_akami_cdn_url = to_app_image_url<akami_app_image_url>("steamcdn-a.akamaihd.net");
